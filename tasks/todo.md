...
- [ ] Beep src/intents.ts publish guard checks only that the message contains the content hash (same weakness the SDK final review found); switch Beep to publishSignedIntent from nana-sdk-core 2.8.0 once published.
