...
- [x] 2026-09-23: every create text field renders on the live, preview and intent pages (homerun PR #9): revenue description, minimum revenue and consequences in the Income stage, profiles' introductions, location, FUND token block on Owners. Follow-ups noted: starting token terms sit in Stages on the live page but under Owners → Splits on the preview; the preview's Splits heading crowds the buttons above it; money formats differ ($7,500.00 live vs $7,500 preview).
