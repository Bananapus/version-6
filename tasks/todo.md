...
- [ ] Center /v1/search returned totalCount 0 for every query (Live, Project, beep, Artizen) on 2026-09-21 after the Beep live check; verify intents (and deployed projects) are indexed for search before webclients rely on mergeSearch.
